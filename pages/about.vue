<template>
	<v-container>
		<v-row>
			<v-col cols="12">
				<h1 class="page-title">Let's Talk About Me</h1>
				<v-row>
				...
				<p>
					...
					client-side code and am comfortably on either side. I've worked for as a tech lead at
					<a
				...
				<p>
					...
					the community at large, and large library of open-source projects depending on it, I
					choose to work in JavaScript primarily for two reasons:
				</p>
				<h3>It Is Isomorphic</h3>
				<p>
					How awesome is it that JavaScript can be run on both the server and the client? I think
					it's pretty awesome, especially since you don't have to code-switch while jumping from
					server to client code and vice versa. I'm sorry, C#, I do prefer my single quotes!
				</p>
				...
				<p>
					...
					community members and open source contributions. Time to refactor and take advantage of
					that new version of today's favorite flavor!
				</p>
				<v-divider />
				...
				<p>
					...
					. I've also picked up woodworking recently, and I've enjoyed building some furniture to
					put in and around the house and garage. I'm learning Spanish. And of course I enjoy all
					the outdoor activites that Colorado has to offer - snowboarding, hiking, backpacking,
					kayaking, cycling, the large selection of craft brew and local breweries, and seeing the
